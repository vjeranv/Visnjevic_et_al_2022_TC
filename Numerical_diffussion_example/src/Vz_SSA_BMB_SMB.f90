...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    !
    Thickness       => VariableGet( Model % Mesh % Variables, 'Thickness',UnFoundFatal=UnFoundFatal)
    ...
    Vz              => VariableGet( Model % Mesh % Variables, 'Velocity 2',UnFoundFatal=UnFoundFatal)
    Vz_val          => Vz    % Values
    Vz_Perm         => Vz    % Perm!
    Vz_val          =  0.0_dp
